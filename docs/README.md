...
| 文档 | 内容 |
|------|------|
| [cmake-build.md](cmake-build.md) | CMake MVP 构建说明（默认无 V8；可选 EnableV8；Windows 产品路径 MSVC `cl` + C++20） |
...
| [en/README.md](en/README.md) | English overview |

根目录 [README.md](../README.md) 为中文入口（含 CI badge）。
